...
ActiveRecord::Schema.define(version: 20160605165148) do
  ...
  add_index "restaurant_comments", ["lft"], name: "index_restaurant_comments_on_lft", using: :btree
  add_index "restaurant_comments", ["parent_id"], name: "index_restaurant_comments_on_parent_id", using: :btree
  add_index "restaurant_comments", ["rgt"], name: "index_restaurant_comments_on_rgt", using: :btree
