...
ActiveRecord::Schema.define(version: 20140518221726) do
  ...
  add_index "activities", ["tenant_id", "created_at"], name: "index_activities_on_tenant_id_and_created_at", using: :btree
  ...
  add_index "multimedia", ["tenant_id"], name: "index_multimedia_on_tenant_id", using: :btree
  add_index "multimedia", ["topic_id"], name: "index_multimedia_on_topic_id", using: :btree

  create_table "multimedia_clips", force: true do |t|
  ...
  add_index "multimedia_clips", ["multimedia_id"], name: "index_multimedia_clips_on_multimedia_id", using: :btree
  add_index "multimedia_clips", ["tenant_id"], name: "index_multimedia_clips_on_tenant_id", using: :btree
