...
describe HomesController do
  ...
  describe "GET new" do
    it "assigns a new home as @home" do
      ...
      assigns(:home).should be_a_new(Home)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created home as @home" do
        post :create, {:home => valid_attributes}, valid_session
        assigns(:home).should be_a(Home)
        assigns(:home).should be_persisted
      end

      it "redirects to the created home" do
        post :create, {:home => valid_attributes}, valid_session
        response.should redirect_to(Home.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved home as @home" do
        ...
        Home.any_instance.stub(:save).and_return(false)
        post :create, {:home => {  }}, valid_session
        assigns(:home).should be_a_new(Home)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested home" do
        ...
        Home.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => home.to_param, :home => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the home as @home" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Home.any_instance.stub(:save).and_return(false)
        put :update, {:id => home.to_param, :home => {  }}, valid_session
        assigns(:home).should eq(home)
      end
